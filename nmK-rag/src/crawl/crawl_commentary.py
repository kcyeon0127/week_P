...
DB_PATH = os.path.join(STATE_DIR, "crawl_commentary_state.db")
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('crawl_commentary.log'),
...
def crawl():
    ...
    processed_count = 0
    pbar = tqdm(total=len(queue), desc="Crawling commentary pages")
